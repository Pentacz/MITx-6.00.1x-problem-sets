...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    '''
    # Get starting points: secretWord, 8guesses, welcome message
    ...
    # Keep asking for input - letters, until 8 mistakes
    while guesses > 0:
        ...
        if g.lower() in lettersGuessed:
            print("Oops! You've already guessed that letter:", getGuessedWord(secretWord, lettersGuessed)) 
        
        # bad guess - -1guesses
        elif g.lower() not in secretWord:
        ...
        # last if to check if word guessed
